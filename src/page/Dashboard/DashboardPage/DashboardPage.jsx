                ...
                <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-bold text-gray-900">{callStats.answeredCalls}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-bold text-gray-900">{callStats.missedCalls}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-bold text-gray-900">{callStats.avgCallDuration}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-bold text-gray-900">{callStats.totalTalkTime}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-bold text-gray-900">{callStats.pendingFollowUps}</p>
                        </div>
                    </div>
                </div>
            </div>
