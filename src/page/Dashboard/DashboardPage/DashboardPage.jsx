...
const DashboardPage = () => {
    ...
    try {
      ...
      if (userRole === 2) {
        ...
        if (response.data.success && response.data.data) {
          ...
          console.warn(
            "⚠️ Manager stats API response structure unexpected:",
            response.data
          );
        ...
        if (response.data.success && response.data.data) {
          ...
          console.warn(
            "⚠️ Agent stats API response structure unexpected:",
            response.data
          );
          return mockCallStats; // Fallback to mock data
        }
  ...
  const fetchRecentCalls = async (period = "today", search = "") => {
    ...
    try {
      ...
      console.log(
        `📞 ${userRole === 2 ? "Manager" : "Agent"} recent calls API response:`,
        response.data
      );
  ...
  const fetchFollowUps = async () => {
    ...
    try {
      ...
      console.log(
        `📋 Fetching follow-ups for ${userRole === 2 ? "manager" : "agent"}:`,
        employeeId,
        "Date range:",
        startDate,
        "to",
      ...
      console.log(
        `📋 ${userRole === 2 ? "Manager" : "Agent"} follow-ups API response:`,
        response.data
      );
          ...
          {SHOW_FLAG_BACKGROUND && (
            <style jsx>{`
              ...
              .chakra-spokes {
                ...
                background: #000080;
                transform: translate(-50%, -50%);
                box-shadow: 0 0 0 0 #000080, 0 0 0 0 rotate(15deg) #000080,
                  0 0 0 0 rotate(30deg) #000080, 0 0 0 0 rotate(45deg) #000080,
                  0 0 0 0 rotate(60deg) #000080, 0 0 0 0 rotate(75deg) #000080,
                  0 0 0 0 rotate(90deg) #000080, 0 0 0 0 rotate(105deg) #000080,
                  0 0 0 0 rotate(120deg) #000080, 0 0 0 0 rotate(135deg) #000080,
                  0 0 0 0 rotate(150deg) #000080, 0 0 0 0 rotate(165deg) #000080;
              }
              ...
              .sparkle-4 {
                top: 80%;
                left: 25%;
                animation: sparkleFloat 2.2s ease-in-out infinite 1.5s;
              }
              .sparkle-5 {
                top: 45%;
                left: 90%;
                animation: sparkleFloat 2.8s ease-in-out infinite 2s;
              }
            ...
            >
              ...
              <div className="grid grid-cols-5 gap-2 text-center">
                ...
                <div>
                  <p className="text-lg font-bold text-purple-600">
                    {formatStatsDuration(
                      callStats?.outbound?.avgCallDuration
                    ) || "0:00"}
                  </p>
                  <p className="text-xs text-gray-500">Avg</p>
                </div>
                ...
                <div className="w-full">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">
                      Call Details -{" "}
                      {selectedCallDetail.customerName || "Unknown Caller"}
                    </h3>
                    <button
                      onClick={closeDetailModal}
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedCallDetail.customerName || "N/A"}
                          </p>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedCallDetail.duration || "N/A"}
                          </p>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500">
                        ...
                        <div className="border-t pt-4 mt-4">
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <p className="text-sm text-gray-900">
                                {selectedCallDetail.formDetail.callType ||
                                  "N/A"}
                              </p>
                            </div>
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-900">
                                {selectedCallDetail.formDetail.inquiryNumber ||
                                  "N/A"}
                              </p>
                            </div>
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-900">
                                {selectedCallDetail.formDetail.SupportType
                                  ?.supportName || "N/A"}
                              </p>
                            </div>
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-900">
                                {selectedCallDetail.formDetail.ProcessType
                                  ?.processName || "N/A"}
                              </p>
                            </div>
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-900">
                                {selectedCallDetail.formDetail.QueryType
                                  ?.queryName || "N/A"}
                              </p>
                            </div>
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-900">
                                {selectedCallDetail.formDetail.remarks ||
                                  "No remarks"}
                              </p>
                            </div>
                            ...
                            <div>
                              ...
                              <span
                                className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                                  selectedCallDetail.formDetail.status ===
                                  "open"
                              ...
                              >
                                {selectedCallDetail.formDetail.status
                                  ?.charAt(0)
                                  .toUpperCase() +
                                  selectedCallDetail.formDetail.status?.slice(
                                    1
                                  ) || "N/A"}
                              </span>
                            </div>
                          ...
                          <div className="border-t pt-4 mt-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-900">
                                  {selectedCallDetail.agentNumber ||
                                    selectedCallDetail.agentId}
                                </p>
                              </div>
                            </div>
                          </div>
