...
const MissedCallsPage = () => {
  ...
  const handleSelectAll = (checked) => {
    if (checked) {
      const selectableCallIds = missedCalls
        .filter((call) => call.status?.needsFollowUp === true)
        .map((call) => call.incomingCall.callId);
      setSelectedCalls(selectableCallIds);
    } else {
      setSelectedCalls([]);
  ...
  // Get status badge
  const getStatusBadge = (call) => {
    if (call.status?.hasFollowUpCall) {
      return "bg-green-100 text-green-800";
    } else if (call.status?.needsFollowUp) {
      return "bg-red-100 text-red-800";
    } else {
      return "bg-yellow-100 text-yellow-800";
    }
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <input
                          ...
                          checked={
                            ...
                            selectedCalls.length ===
                              missedCalls.filter(
                                (call) => call.status?.needsFollowUp === true
                              ).length &&
                            missedCalls.filter(
                              (call) => call.status?.needsFollowUp === true
                            ).length > 0
                  ...
                  {missedCalls.map((call) => {
                    ...
                    return (
                      <tr
                        ...
                        className="hover:bg-gray-50"
                      >
                        {/* Individual Checkbox - Only for Manager/Admin and calls needing follow-up */}
                        {isManagerOrAdmin && (
                          <td className="px-6 py-4">
                            {call.status?.needsFollowUp === true ? (
                              <input
                                type="checkbox"
                                checked={selectedCalls.includes(
                                  call.incomingCall.callId
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              ...
                              {call.incomingCall.customerDetails && (
                          ...
                          <td className="px-6 py-4">
                            {call.incomingCall.agentNumber ? (
                              <div className="text-sm text-gray-900">
                                ...
                                <div className="text-xs text-gray-500">
                                  {call.incomingCall.agentDetails
                                    ?.EmployeeName || "Agent was available"}
                                </div>
                              </div>
                            ) : (
                              <div className="text-sm text-gray-500">
                        ...
                        <td className="px-6 py-4">
                          ...
                          >
                            {call.status?.hasFollowUpCall ? (
                              <CheckCircleIcon className="w-3 h-3 mr-1" />
                            ) : call.status?.needsFollowUp ? (
                              <ExclamationTriangleIcon className="w-3 h-3 mr-1" />
                            ) : (
                              <XCircleIcon className="w-3 h-3 mr-1" />
                            )}
                        ...
                        <td className="px-6 py-4">
                          {call.followUpCall ? (
                            <div className="text-sm">
                              <div className="font-medium text-green-700">
                                Call ID: {call.followUpCall.callId}
                              </div>
                              <div className="text-xs text-gray-500">
                                Type:{" "}
                                {call.followUpCall.type === "outgoing"
                                  ? "Outbound"
                                  : "Inbound"}
                              </div>
                              <div className="text-xs text-gray-500">
                                Duration:{" "}
                                {formatDuration(
                                  call.followUpCall.totalCallDuration
                                )}
                              </div>
                              {call.followUpCall.type === "outgoing" &&
                                call.followUpCall.bDialStatus && (
                                  <div className="text-xs text-gray-500">
                                    Status: {call.followUpCall.bDialStatus}
                                  </div>
                                )}
                            </div>
                          ) : (
                        ...
                        <td className="px-6 py-4">
                          {call.formDetails ? (
                            <div className="text-sm">
                              <div className="flex items-center">
                                <DocumentTextIcon className="w-3 h-3 mr-1 text-blue-600" />
                                <span className="text-blue-700 font-medium">
                                  Form Filled
                                </span>
                              </div>
                              {call.formDetails.ProblemCategory && (
                                <div className="text-xs text-gray-600 mt-1">
                                  {call.formDetails.ProblemCategory.problemName}
                                </div>
                              )}
                              {call.formDetails.ProblemSubCategory && (
                                <div className="text-xs text-gray-500">
                                  {
                                    call.formDetails.ProblemSubCategory
                                      .subProblemName
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                  ...
                  <div className="space-y-3">
                    ...
                    {selectedCall.incomingCall.customerDetails && (
                      <div className="mt-4 pt-4 border-t border-red-200">
                        ...
                        <div className="text-sm text-gray-600">
                          ...
                          {selectedCall.incomingCall.customerDetails.Region && (
                            <div>
                              Region:{" "}
                              {selectedCall.incomingCall.customerDetails.Region}
                            </div>
                ...
                {selectedCall.followUpCall ? (
                  <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                    <h3 className="text-lg font-semibold text-green-900 mb-4 flex items-center">
                      <PhoneArrowUpRightIcon className="w-5 h-5 mr-2" />
                      Follow-up Call (
                      {selectedCall.followUpCall.type === "outgoing"
                        ? "Outbound"
                        : "Inbound"}
                      )
                    </h3>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Call ID:</span>
                        <span className="font-medium">
                          {selectedCall.followUpCall.callId}
                        </span>
                      </div>
                      ...
                      {selectedCall.followUpCall.type === "outgoing" ? (
                        <>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Agent Number:</span>
                            <span className="font-medium">
                              {selectedCall.followUpCall.agentNumber || "N/A"}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {selectedCall.followUpCall.customerNumber}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Start Time:</span>
                            <span className="font-medium">
                              {new Date(
                                selectedCall.followUpCall.callStartTime
                              ).toLocaleString()}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {selectedCall.followUpCall.bPartyConnectedTime
                                ? new Date(
                                    selectedCall.followUpCall.bPartyConnectedTime
                                  ).toLocaleString()
                                : "Not connected"}
                          ...
                          <div className="flex justify-between">
                            <span className="text-gray-600">Status:</span>
                            <span className="font-medium">
                              {selectedCall.followUpCall.bDialStatus}
                            </span>
                          </div>
                        </>
                      ) : (
                        <>
                          ...
                          <div className="flex justify-between">
                            <span className="text-gray-600">End Time:</span>
                            <span className="font-medium">
                              {selectedCall.followUpCall.callEndTime
                                ? new Date(
                                    selectedCall.followUpCall.callEndTime
                                  ).toLocaleString()
                                : "N/A"}
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {formatDuration(
                            selectedCall.followUpCall.totalCallDuration
                          )}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
                    ...
                    <div className="text-center py-8">
                      <ExclamationTriangleIcon className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
                      <p className="text-yellow-700 mb-4">
                        {selectedCall.status?.needsFollowUp
                          ? "This missed call requires a callback"
                          : "No callback needed for this missed call"}
                      </p>
                      {selectedCall.status?.needsFollowUp && (
              ...
              {selectedCall.formDetails && (
                <div className="mt-6 bg-blue-50 rounded-lg p-4 border border-blue-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {selectedCall.formDetails.ProblemCategory && (
                      <div>
                        <label className="text-sm font-medium text-gray-600">
                          Problem Category:
                        </label>
                        <div className="text-sm text-gray-900">
                          {selectedCall.formDetails.ProblemCategory.problemName}
                        </div>
                      </div>
                    )}
                    {selectedCall.formDetails.ProblemSubCategory && (
                      <div>
                        <label className="text-sm font-medium text-gray-600">
                          Sub Category:
                        </label>
                    ...
                    {selectedCall.formDetails.remarks && (
              ...
              {/* Voice Recording Section */}
              {(selectedCall.incomingCall.voiceRecording ||
                selectedCall.followUpCall?.recordVoice) && (
                <div className="mt-6 bg-purple-50 rounded-lg p-4 border border-purple-200">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">
                    Voice Recordings
                  </h3>
                  <div className="flex flex-wrap gap-4">
                    ...
                    {selectedCall.followUpCall?.recordVoice && (
                      <a
                        href={selectedCall.followUpCall.recordVoice}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700"
                      >
                        <PlayIcon className="w-4 h-4 mr-2" />
                        Play Follow-up Call Recording
                      </a>
                    )}
                  </div>
                </div>
                ...
                <details>
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    {selectedCall.followUpCall && (
                      <div>
                        <h4 className="font-medium text-gray-900 mb-2">
                          Follow-up Call Raw Data:
                        </h4>
                        <pre className="text-xs bg-white p-3 rounded border overflow-x-auto">
                          {JSON.stringify(
                            selectedCall.followUpCall.rawData,
                            null,
                            2
                          )}
                        </pre>
