  ...
  const fetchFollowUps = async () => {
    try {
      ...
      if (response.data.success && response.data.data) {
        const { totalRecords, currentPage, totalPages, recordsPerPage, records } = response.data.data;
        ...
        const openCount = transformedFollowUps.filter(f => f.status === 'open').length;
        const closedCount = transformedFollowUps.filter(f => f.status === 'closed').length;
    ...
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-3 border border-blue-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="text-xs text-blue-600">Total Follow-ups</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-3 border border-green-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <div className="text-base font-semibold text-green-900">{stats?.open || 0}</div>
              ...
              <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-lg p-3 border border-gray-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <div className="text-base font-semibold text-gray-900">{stats?.closed || 0}</div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredFollowUps.map((followUp) => {
                    const { date, time } = formatDateTime(followUp.callDateTime);
                      ...
                      <tr key={followUp.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              <div className="text-sm font-medium text-gray-900">{followUp.traderName}</div>
                              <div className="text-sm text-gray-500 flex items-center">
                                <PhoneIcon className="h-3 w-3 mr-1" />
                                {followUp.traderContact}
                              </div>
                              <div className="text-xs text-gray-400">Code: {followUp.traderCode}</div>
                            </div>
                          </div>
                        </td>
                        ...
                        {/* Support Details */}
                        <td className="px-6 py-4">
                          <div className="text-sm text-gray-900">{followUp.supportType}</div>
                          <div className="text-sm text-gray-500">{followUp.processType}</div>
                          <div className="text-xs text-gray-400">{followUp.queryType}</div>
                        </td>
                                ...
                                {followUp.remarks.length > 50 ? (
                                  <div>
                                    {expandedRemarks.has(followUp.id) ? (
                                      ...
                                      <div>
                                        <span>{followUp.remarks.substring(0, 50)}...</span>
                                        <button
                                          onClick={() => {
                                            const newExpanded = new Set(expandedRemarks);
                        ...
                        <td className="px-6 py-4 text-sm font-medium sticky right-0 bg-white shadow-lg">
                          <div className="flex flex-col space-y-1">
                            ...
                            <button 
                              onClick={() => handleCall(followUp.traderContact, followUp.traderName)}
      ...
      {showDetailsModal && selectedFollowUp && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" style={{ zIndex: 9999 }}>
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto" style={{ zIndex: 9999 }}>
            <div className="p-6">
              {/* Modal Header */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Trader Information</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Name:</span>
                      <span className="font-medium">{selectedFollowUp.traderName}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Contact:</span>
                      <span className="font-medium">{selectedFollowUp.traderContact}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Code:</span>
                      <span className="font-medium">{selectedFollowUp.traderCode}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Region:</span>
                      <span className="font-medium">{selectedFollowUp.region}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{selectedFollowUp.callId}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Call Type:</span>
                      <span className="font-medium">{selectedFollowUp.callType}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Call Date:</span>
                      <span className="font-medium">{formatDateTime(selectedFollowUp.callDateTime).date}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Call Time:</span>
                      <span className="font-medium">{formatDateTime(selectedFollowUp.callDateTime).time}</span>
                    </div>
                  </div>
                </div>
                ...
                {/* Support Details */}
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Support Details</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Support Type:</span>
                      <span className="font-medium">{selectedFollowUp.supportType}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Process Type:</span>
                      <span className="font-medium">{selectedFollowUp.processType}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Query Type:</span>
                      <span className="font-medium">{selectedFollowUp.queryType}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{selectedFollowUp.agentName}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Agent Phone:</span>
                      <span className="font-medium">{selectedFollowUp.agentPhone}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Region:</span>
                      <span className="font-medium">{selectedFollowUp.region}</span>
              ...
              <div className="mt-6 bg-blue-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{new Date(selectedFollowUp.followUpDate).toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Status:</span>
                    <span className="font-medium">{formatFollowUpDate(selectedFollowUp.followUpDate).text}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 flex justify-between">
                <button
                  onClick={() => handleCall(selectedFollowUp.traderContact, selectedFollowUp.traderName)}
