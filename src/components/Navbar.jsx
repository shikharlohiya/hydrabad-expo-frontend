...
const Navbar = ({ collapsed, setCollapsed }) => {
    ...
    return (
        ...
        >
            ...
            <div className={`px-4 pt-4 pb-2 transition-all duration-300 flex-shrink-0 ${collapsed ? 'px-3' : ''}`}>
                <div className="flex items-center justify-between">
                    <div className={`text-md font-semibold text-white uppercase tracking-wider transition-all duration-300 ${collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100 w-auto'}`}>
                        Menu
                    </div>
