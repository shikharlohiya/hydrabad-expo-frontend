...
const CallRemarksPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className={`fixed top-16 right-0 bottom-0 w-96 bg-white shadow-lg border-l border-gray-200 transform transition-transform duration-300 ease-in-out z-50 ${showCustomerPanel ? 'translate-x-0' : 'translate-x-full'
                }`}>
