            ...
            <div className="h-full flex items-center justify-between px-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button className="p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors relative">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-3.5-3.5c-.8-.8-1.3-1.9-1.3-3v-2c0-3.3-2.7-6-6-6s-6 2.7-6 6v2c0 1.1-.5 2.2-1.3 3L0 17h5m5 0v1a3 3 0 11-6 0v-1m6 0H9" />
                        </svg>
                        {/* Notification badge */}
